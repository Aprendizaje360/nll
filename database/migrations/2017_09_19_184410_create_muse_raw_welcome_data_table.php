...
class CreateMuseRawWelcomeDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('muse_raw_welcome_data', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('muse_raw_welcomes');
    }
}
