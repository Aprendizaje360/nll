...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'enterprise_auth' => \App\Http\Middleware\AuthenticateEnterprise::class,
        'enterprise_guest' => \App\Http\Middleware\RedirectIfEnterpriseAuthenticated::class,
        'superadmin_only' => \App\Http\Middleware\SuperAdminOnly::class,
        'int_perm' => \App\Http\Middleware\InterventionPermission::class,
    ];
}
