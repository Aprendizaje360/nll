...
class UpdateSequence extends FormRequest
{
    /**
    ...
    {
        return [
            'title' => 'required|unique:sequences,title,' . $this->route('sequence')->id,
            'order' => 'required|unique:sequences,order,' . $this->route('sequence')->id,
